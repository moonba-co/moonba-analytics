      ...
      <BlockedWrapper>
        <BlockedMessageWrapper>
          <AutoColumn gap="1rem" justify="center">
            ...
            <Link external={true} href={'https://mainnet-explorer.oneledger.network/address/' + pairAddress}>{`More about ${shortenAddress(
              pairAddress
            )}`}</Link>
          </AutoColumn>
        </BlockedMessageWrapper>
              ...
              >
                <TokenDetailsLayout>
                  ...
                  <ButtonLight color={backgroundColor}>
                    <Link color={backgroundColor} external href={'https://mainnet-explorer.oneledger.network/address/' + pairAddress}>
                      View on Blockscout ↗
                    </Link>
                  </ButtonLight>
                </TokenDetailsLayout>
